...
// components
import { Box, Chip, Divider, TextField, Stack, IconButton, InputAdornment } from "@mui/material";
...
function LoginForm() {
    ...
    return (
        <>
                ...
                InputProps={{
                    endAdornment: (
                        <InputAdornment position="end">
                            <IconButton aria-label="password-visibility" onClick={() => setShowPassword(!showPassword)} edge="end">
            ...
            <Box width="80%" mb={2}>
                <Divider>
                    <Chip label="透過其他平台登入" sx={{ backgroundColor: "neutral.light" }}></Chip>
                </Divider>
            </Box>
