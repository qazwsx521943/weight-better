...
function RegisterForm() {
    ...
    const validation = async (e) => {
        ...
        if (name === "email") {
            ...
            dispatch({ type: "inputError", errMsg: { email: `${validEmail ? "" : "email格式不正確"}` } });
        ...
        if (name === "username") {
            ...
            dispatch({ type: "inputError", errMsg: { username: `${validUsername ? "" : "帳號名稱需至少8位數，且不得包含特殊符號"}` } });
        ...
        if (name === "password") {
            ...
            dispatch({ type: "inputError", errMsg: { password: `${validPwd ? "" : "密碼需至少8位數，且需包含大小寫及特殊符號"}` } });
        }
        ...
        if (name === "matchPwd") {
            ...
            dispatch({ type: "inputError", errMsg: { matchPwd: `${validMatch ? "" : "確認密碼與輸入密碼需相同！"}` } });
        }
    };
