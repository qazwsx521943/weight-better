...
const tablist = [
    ...
    { name: "introduction", label: "自我介紹", icon: <PaletteIcon size="small" />, type: "textarea" },
    ...
    return (
        <Box display={"flex"} flexDirection="column" justifyContent="center" m={"20px"}>
            <Paper
                variant="outlined"
                square
                sx={{ padding: "30px 5px", borderColor: "primary.light", borderRadius: "8px", backgroundColor: "neutral.light" }}>
                <Box
